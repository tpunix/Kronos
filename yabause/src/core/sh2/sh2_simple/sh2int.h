...
void FASTCALL SH2InterpreterExecSave(SH2_struct *context, u32 cycles, sh2regs_struct *oldRegs);
...
void FASTCALL SH2DebugInterpreterExecSave(SH2_struct *context, u32 cycles, sh2regs_struct *oldRegs);
